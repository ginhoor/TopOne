...
import 'package:top_one/model/home_item.dart';
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  List<HomeItem> items = HomeItem.homeItems;
          ...
          callBack: () {
            Navigator.push<dynamic>(
              ...
              MaterialPageRoute<dynamic>(
                builder: (BuildContext context) => items[index].navigateScreen!,
              ),
            );
          },
        );
